...
Returns all pool creation events with their initial parameters.
...
Returns the latest book parameter update event for a specific pool. This tracks changes to tick size, lot size, and min size.
